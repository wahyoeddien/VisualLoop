 ...
 * @author Nurhikmah
 */
public class Wahyuddin extends Application implements Runnable {
    ...
    private void update() {
        ...
        if(inputKeyboard.contains("UP")){//Menggerakkan Kotak ke atas saat Key UP ditekan
            cy--;
        }else if(inputKeyboard.contains("DOWN")){//Menggerakkan Kotak saat Key DOWN ditekan
            cy++;
        }
        if(inputKeyboard.contains("R")){//Menggerakkan Kotak se arah jarum jam saat Key R ditekan
            sudutRotasi++;
        }
    }
